...
public class Drone {
	...
	public void update(int deltaTime) {
		...
		double distancedMoved = (speed_sensor*100)*((double)deltaTime/1000);
	...
	public void speedUp(int deltaTime) {
		speed_sensor += (WorldParams.accelerate_per_second*deltaTime/1000);
		if(speed_sensor > WorldParams.max_speed) {
			speed_sensor =WorldParams.max_speed;
		}
	}
